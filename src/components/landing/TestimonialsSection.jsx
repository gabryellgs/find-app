...
const testimonials = [
  {
    text:     'Perdi minha carteira com todos os documentos importantes e consegui recuperar em menos de 3 horas. Indiquei a todos.',
    name:     'Ana Martins',
    role:     'Estudante (UFRN)',
    city:     'Natal, RN',
    initials: 'AM',
    ...
    item:     { icon: 'wallet-outline', label: 'Carteira recuperada' },
    time:     '3h',
  },
  {
    text:     'Devolvi um celular que encontrei no metrô. O sistema me deu toda a segurança para entrar em contato. Foi muito gratificante.',
    name:     'Rafael Costa',
  ...
  {
    text:     'Esqueci meu notebook de trabalho em uma lanchonete. Cadastrei no Find e o gerente logo me contatou. A comunidade é fantástica!',
    name:     'Juliana Santos',
    role:     'Professora',
    city:     'Parnamirim, RN',
    initials: 'JS',
    ...
    avatarColor: '#6d28d9',
    item:     { icon: 'laptop-outline', label: 'Laptop recuperado' },
    time:     '—',
  },
];
